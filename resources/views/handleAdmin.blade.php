                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h1 font-weight-bold mb-0">350,897</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats bg-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase mb-0">Buku Dipinjam</h5>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats bg-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase mb-0">Buku</h5>
